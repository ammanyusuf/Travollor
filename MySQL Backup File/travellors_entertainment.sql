...
CREATE TABLE `entertainment` (
  ...
  CONSTRAINT `attraction_id_entertainment` FOREIGN KEY (`attraction_id`) REFERENCES `attraction` (`attraction_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `entertainment` VALUES (8,'Club'),(9,'Movies');
