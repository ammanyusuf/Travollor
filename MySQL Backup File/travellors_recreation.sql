...
CREATE TABLE `recreation` (
  ...
  KEY `attraction_id_recreation` (`attraction_id`),
  CONSTRAINT `attraction_id_recreation` FOREIGN KEY (`attraction_id`) REFERENCES `attraction` (`attraction_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `recreation` VALUES (3,'Sport'),(1,'Beach'),(2,'Beach');
